                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <a href="#"
                               class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Bots</a>
                            <a href="#"
                               class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Rules</a>
                            <a href="#"
                               class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Settings</a>
                            <a href="#"
                               class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Plans</a>
                        </div>
                    </div>
                </div>
                <div class="md:block">
                    <div class="ml-4 flex items-center md:ml-6">
                        ...
                        <!-- Profile dropdown -->
                        <ProfileDropDown
                            :list="[{title: 'Yor Profile', link: '/app/profile'}, {title: 'Settings', link: '/app/settings'}, {title: 'Sign out', link: '#', action: () => signOutAction()}]"/>
                    </div>
                </div>
                <div class="-mr-2 flex md:hidden hidden">
                    <!-- Mobile menu button -->
